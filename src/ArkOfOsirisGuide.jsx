      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-amber-700/90 to-orange-600/90 backdrop-blur-sm rounded-t-lg p-6 shadow-2xl border border-amber-500/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Ark of Osiris Guide</h1>
              <p className="text-amber-100 mt-1">Complete strategy guide for RoK's premier alliance event</p>
            </div>
          </div>
        </div>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 font-semibold transition-all whitespace-nowrap ${
                  activeTab === tab.id
                    ? 'bg-amber-600 text-white border-b-2 border-amber-300'
                    : 'text-amber-200 hover:bg-stone-700 hover:text-white'
                }`}
              >
                {tab.icon}
                {tab.label}
        ...
        <div className="bg-stone-900/90 backdrop-blur-sm p-6 shadow-2xl border-x border-b border-amber-700/30 rounded-b-lg">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <QuickStat icon={<Users />} label="Team Size" value="~30 vs 30" />
                <QuickStat icon={<Clock />} label="Duration" value="60 min" />
                <QuickStat icon={<MapPin />} label="Map Lanes" value="3 or 5" />
                <QuickStat icon={<Trophy />} label="Win Condition" value="Most Points" />
              </div>
          ...
          {activeTab === 'roles' && (
            <div className="space-y-6">
              <p className="text-stone-400">
                A well-organized team assigns specific roles. If you're a low-power player and not first to teleport, 
                you'll have 5 different jobs to rotate between:
              </p>
              ...
              <div className="grid gap-4">
                ...
                />
                <RoleCard 
                  role="Farmers / Gatherers"
                  emoji="🌾"
                  count="Low-power players"
                  duties={[
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <StrategyCard 
                  ...
                  icon="📦"
                  tips={[
                    "Ark spawns in the center",
                    "Carrier moves slower — rotate often",
                    "2 pts/sec is massive over time",
                    "NEVER pick from enemy side!"
                  ]}
                />
                <StrategyCard 
                  title="Gathering Points"
                  icon="🌾"
                  tips={[
                    "Massive points from supply/caravans",
                    "Use farmers: Joan, Sarka, Constance",
                    "Go node to node continuously",
                    "Low-power players should prioritize this"
                  ]}
                />
                <StrategyCard 
                  title="Communication"
                  icon="📢"
                  tips={[
                    "Always be on Discord",
                    "Listen to calls from leaders",
                    "Everyone take the same call (even bad ones)",
                    "Communication makes teams win"
                  ]}
                />
                <StrategyCard 
                  title="Building Defense"
                  icon="🏰"
                  tips={[
                    "Don't rail all buildings to middle",
                    "Keep march on back buildings",
                    "Forward buildings need less defense",
                    "Protect structures from being stolen"
                  ]}
                />
              </div>
            </div>
          ...
          {activeTab === 'tips' && (
            <div className="space-y-4">
              <ProTip 
                number={1}
                title="Clear Hospital & Set Equipment"
              ...
              <ProTip 
                number={2}
                title="Use Defense Boost, Not Attack"
              ...
              <ProTip 
                number={3}
                title="25% Army Expansion is Enough"
              ...
              <ProTip 
                number={4}
                title="Fastest Obelisk Capture: T1 Cavalry"
              ...
              <ProTip 
                number={5}
                title="Never Pick Ark from Enemy Side"
              ...
              <ProTip 
                number={6}
                title="Gather for Massive Points"
              ...
              <ProTip 
                number={7}
                title="Listen to Calls — Even Bad Ones"
